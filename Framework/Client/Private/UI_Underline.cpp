...
CUI_Underline::CUI_Underline(const CUI_Underline & rhs)	
	: CGameObject(rhs)
{
}
...
void CUI_Underline::Tick(_float fTimeDelta)
{

}

void CUI_Underline::LateTick(_float fTimeDelta)
{
...
HRESULT CUI_Underline::Add_Component()
{
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Components(m_pGameInstance->Get_NextLevelIndex(), TEXT("Prototype_Component_UI_Underline"),
...
HRESULT CUI_Underline::Bind_ShaderResources()
{
...
CUI_Underline * CUI_Underline::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, void* pArg)
{
	/* 원형객체를 생성한다. */
