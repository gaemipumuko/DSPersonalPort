...
class CKuro_Obi final : public CGameObject
{

private:
	CKuro_Obi(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CKuro_Obi(const CKuro_Obi& rhs);
	virtual ~CKuro_Obi() = default;
...
public:
	/* 원형객체를 생성할 때 */
	static CKuro_Obi* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
