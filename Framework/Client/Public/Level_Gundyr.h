...
class CLevel_Gundyr final : public CLevel
{
private:
	CLevel_Gundyr(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CLevel_Gundyr() = default;
...
public:
	static CLevel_Gundyr* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
