...
class CSouls_Indicator final : public CGameObject
{

private:
	CSouls_Indicator(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CSouls_Indicator(const CSouls_Indicator& rhs);
	virtual ~CSouls_Indicator() = default;
...
public:
	/* 원형객체를 생성할 때 */
	static CSouls_Indicator* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
