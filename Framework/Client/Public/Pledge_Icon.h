...
class CPledge_Icon final : public CGameObject
{


private:
	CPledge_Icon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPledge_Icon(const CPledge_Icon& rhs);
	virtual ~CPledge_Icon() = default;
...
public:
	/* 원형객체를 생성할 때 */
	static CPledge_Icon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
