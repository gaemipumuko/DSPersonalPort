...
HRESULT CGraphic_Device::Initialize(HWND hWnd, GRAPHIC_DESC::WINMODE eWinMode, _uint iWinCX, _uint iWinCY, ID3D11Device** ppDeviceOut, ID3D11DeviceContext** ppDeviceContextOut)
{
	// LPDIRECT3DTEXTURE9
...
CGraphic_Device * CGraphic_Device::Create(HWND hWnd, GRAPHIC_DESC::WINMODE eWinMode, _uint iWinCX, _uint iWinCY, ID3D11Device ** ppDevice, ID3D11DeviceContext ** ppContext)
{
